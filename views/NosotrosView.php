...
<head>
  ...
  <link rel="stylesheet" type="text/css" href="css/btn-label.css">
	...
	<div class="main-nav">
      <div class="container">
        <div class="navbar-header">
          ...
          <a class="navbar-brand" href="ViewMenu.html">
    ...
    <div class="container">
      <div class="row">
        <div class="heading text-center col-sm-8 col-sm-offset-2 wow fadeInUp" data-wow-duration="1200ms" data-wow-delay="300ms">
         ...
         <h4> <p>Desarrollamos trabajos con las últimas tendencias tecnológicas</p></h4>
        </div>
      </div>
          ...
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="300ms">
              <div class="member-image">
                <img class="img-responsive" src="../images/mujer.png" alt="">
              </div>
              <div class="member-info">
                <h3>Paola Gomez</h3>
                <h4>Analísta en Sistemas</h4>
                <p>Encargada en el diseño del sistema</p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
            <div class="team-member wow flipInY" data-wow-duration="1000ms" data-wow-delay="500ms">
              <div class="member-image">
                <img class="img-responsive" src="../images/hombre.png" alt="">
              </div>
              <div class="member-info">
                <h3>Juan Galárraga</h3>
                <h4>Desarrollador</h4>
                <p>Programador de módulos</p>
              </div>
            </div>
          </div>
          <div class="col-sm-3">
